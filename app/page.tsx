                ...
                <div className="flex flex-1 overflow-hidden h-full">
                  ...
                  <div className="flex-1 p-2 bg-slate-200 overflow-hidden flex flex-col min-h-0 planning-container">
                    <div id="calendar-capture-zone" className="flex-1 bg-white rounded-lg shadow border border-slate-300 overflow-x-auto overflow-y-auto flex flex-col min-h-0">
                      <div style={{ gridTemplateColumns: gridTemplate, backgroundColor: '#c4d79b', minWidth: '500px' }} className={`${gridBaseClasses} sticky top-0 z-20`}>
                      ...
                      <div className="flex-1 flex flex-col items-stretch bg-slate-50/30 min-h-0 container-export-rows">
                        {DAYS.map((day, dayIndex) => (
                          <div key={day} className={dayIndex > 0 && (day === 'Mercredi' || day === 'Jeudi') ? 'mt-4' : ''}>
                            <div style={{ gridTemplateColumns: gridTemplate, minWidth: '500px' }} className={`${gridBaseClasses} w-full bg-white items-stretch overflow-visible min-h-[45px] flex-1 export-row`}>
                            <div className="bg-white flex items-center justify-center py-1 overflow-visible min-h-[41px] border border-black" style={{ backgroundColor: '#c4d79b', fontFamily: '"Comic Sans MS", cursive, sans-serif' }}>
